...
class ESelect2 extends CInputWidget
{
    ...
    public function init()
    {
        $this->defaultOptions = array(
            ...
            'formatInputTooShort' => 'js:function(input,min){return "' . Yii::t('ESelect2.select2', 'Digite más de {chars} caracteres para iniciar busqueda', array('{chars}' => '"+(min-input.length)+"')) . '";}',
