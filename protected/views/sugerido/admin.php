...
$lista_cargos = CHtml::listData($cargos, 'Cargo', 'Cargo');  

?>

<h3>Administración de sugeridos</h3>

<div class="btn-group" style="padding-bottom: 2%">
   <button type="button" class="btn btn-success" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=sugerido/create'; ?>';"><i class="fa fa-plus"></i> Nuevo registro</button>
