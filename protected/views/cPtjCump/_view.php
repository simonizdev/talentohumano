...
<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('CUM_INICIAL')); ?>:</b>
	<?php echo CHtml::encode($data->CUM_INICIAL); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('CUM_FINAL')); ?>:</b>
	<?php echo CHtml::encode($data->CUM_FINAL); ?>
	<br />
