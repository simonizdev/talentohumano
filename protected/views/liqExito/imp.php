...
<div class="btn-group" style="padding-bottom: 2%" id="buttons">
  <button type="button" class="btn btn-success" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/images/plantillas/liquidacion_exito.xlsx'; ?>';"><i class="fa fa-download"></i> Descargar plantilla</button>
...
$(function() {
  ...
  $("#valida_form").click(function() {
      ...
      var form = $("#liq-exito-form");
      var settings = form.data('settings');

      var archivo = $('#LiqExito_archivo').val();
      ...
      if(valid_file == 1){
        ...
        var formData = new FormData($("#liq-exito-form")[0]);
        var message = ""; 
        //hacemos la petición ajax  
        $.ajax({
            url: "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=LiqExito/uploadfile'; ?>",  
            type: 'POST',
            // Form data
  ...
  $("#LiqExito_archivo").change(function () {
  ...
  $("#LiqExito_archivo").click(function () {
