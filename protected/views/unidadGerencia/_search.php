...
?>
		...
		<div class="row">
		    <div class="col-sm-3">
		    	<div class="form-group">
				    ...
				    <?php echo $form->numberField($model,'Id_Unidad_Gerencia', array('class' => 'form-control', 'autocomplete' => 'off', 'type' => 'number')); ?>
		        </div>
		    </div>
		    <div class="col-sm-3">
		    	<div class="form-group">
		          	<?php echo $form->label($model,'Unidad_Gerencia'); ?>
				    <?php echo $form->textField($model,'Unidad_Gerencia', array('class' => 'form-control', 'autocomplete' => 'off')); ?>
		        </div>
		    </div>
		</div>
		<div class="row">
		    	...
		    	<div class="form-group">
	            	...
	            	<?php
	            		$this->widget('ext.select2.ESelect2',array(
							'name'=>'UnidadGerencia[usuario_creacion]',
							'id'=>'UnidadGerencia_usuario_creacion',
							'data'=>$lista_usuarios,
							'htmlOptions'=>array(),
						  	'options'=>array(
		    ...
		    <div class="col-sm-3">
		    	<div class="form-group">
	            	...
	            	<?php
	            		$this->widget('ext.select2.ESelect2',array(
							'name'=>'UnidadGerencia[usuario_actualizacion]',
							'id'=>'UnidadGerencia_usuario_actualizacion',
							'data'=>$lista_usuarios,
							'htmlOptions'=>array(),
						  	'options'=>array(
	    						'placeholder'=>'Seleccione...',
	...
	<script type="text/javascript">
		...
		function resetfields(){
			...
			$('#UnidadGerencia_usuario_creacion').val('').trigger('change');
			$('#UnidadGerencia_Fecha_Creacion').val('');
			$('#UnidadGerencia_usuario_actualizacion').val('').trigger('change');
