...
$lista_estados_all = CHtml::listData($estados_all, 'Id_Dominio', 'Dominio'); 
...
<?php $this->renderPartial('_form', array('model'=>$model, 'lista_tipos_asoc'=>$lista_tipos_asoc, 'lista_tipos'=>$lista_tipos, 'lista_dominios'=>$lista_dominios, 'lista_estados_all' => $lista_estados_all, 'lista_estados'=>$lista_estados)); ?>
...
$(function() {
  ...
  $("#Cuenta_Tipo_Asociacion").change(function() {
    ...
    if(valor != ''){
      ...
      if(valor == <?php echo Yii::app()->params->ta_correo ?>){
        ...
        $('#Cuenta_Estado2').val('').trigger('change');
  ...
  $("#valida_form").click(function() {
    ...
    if(tipo_asoc == ''){
      ...
      if(
        ...
        var estado1  = $('#Cuenta_Estado').val();

        var estado2  = $('#Cuenta_Estado2').val();

        var correo_red = "";
        
        if(tipo_asoc == <?php echo Yii::app()->params->ta_correo ?>){
          //CORREO
          if(tipo_correo != "" && usuario_correo != "" && dominio_correo != "" && cuenta_correo != "" && password_correo != "" && estado1 != ""){

            if(estado1 == <?php echo Yii::app()->params->estado_red_env ?> || estado1 == <?php echo Yii::app()->params->estado_red_ret ?> || estado1 == <?php echo Yii::app()->params->estado_red_vac ?>){
              
              //Cuenta de redirección
              cuenta_red = $('#Cuenta_Cuenta_Correo_Red').val();

              if(cuenta_red == ""){
                $('#error_cuenta_red').html('Cuenta de correo para redirección no puede ser nulo');
                $('#error_cuenta_red').show();
              }else{
            ...
            if(estado1 == ""){
              $('#error_estado_1').html('Estado no puede ser nulo');
              $('#error_estado_1').show(); 
            }
        ...
        if(tipo_asoc == <?php echo Yii::app()->params->ta_correo_glpi_papercut ?>){
          //CORREO - GLPI - PAPERCUT
          if(tipo_correo != "" && usuario_correo != "" && dominio_correo != "" && cuenta_correo != "" && password_correo != "" && cuenta_glpi != "" && password_glpi != "" && cuenta_papercut != "" && password_papercut != "" && estado1 != ""){
        ...
        if(tipo_asoc == <?php echo Yii::app()->params->ta_correo_siesa_papercut ?>){
          //CORREO - SIESA - PAPERCUT
          if(tipo_correo != "" && usuario_correo != "" && dominio_correo != "" && cuenta_correo != "" && password_correo != "" && cuenta_siesa != "" && password_siesa != "" && cuenta_papercut != "" && password_papercut != "" && estado1 != ""){
        ...
        if(tipo_asoc == <?php echo Yii::app()->params->ta_correo_siesa_glpi_papercut ?>){
          //CORREO - SIESA - GLPI - PAPERCUT
          if(tipo_correo != "" && usuario_correo != "" && dominio_correo != "" && cuenta_correo != "" && password_correo != "" && cuenta_siesa != "" && password_siesa != "" && cuenta_glpi != "" && password_glpi != "" && cuenta_papercut != "" && password_papercut != "" && estado1 != ""){
        ...
        if(tipo_asoc == <?php echo Yii::app()->params->ta_correo_skype_papercut ?>){
          ...
          if(tipo_correo != "" && usuario_correo != "" && dominio_correo != "" && cuenta_correo != "" && password_correo != "" && cuenta_skype != "" && password_skype != "" && cuenta_papercut != "" && password_papercut != "" && estado1 != ""){
            if(estado1 == <?php echo Yii::app()->params->estado_red_env ?> || estado1 == <?php echo Yii::app()->params->estado_red_ret ?> || estado1 == <?php echo Yii::app()->params->estado_red_vac ?>){
        ...
        if(tipo_asoc == <?php echo Yii::app()->params->ta_correo_skype_glpi_papercut ?>){
          //CORREO - SKYPE - GLPI - PAPERCUT
          if(tipo_correo != "" && usuario_correo != "" && dominio_correo != "" && cuenta_correo != "" && password_correo != "" && cuenta_skype != "" && password_skype != "" && cuenta_glpi != "" && password_glpi != "" && cuenta_papercut != "" && password_papercut != "" && estado1 != ""){
        ...
        if(tipo_asoc == <?php echo Yii::app()->params->ta_correo_skype_siesa_papercut ?>){
          //CORREO - SKYPE - SIESA - PAPERCUT
          if(tipo_correo != "" && usuario_correo != "" && dominio_correo != "" && cuenta_correo != "" && password_correo != "" && cuenta_skype != "" && password_skype != "" && cuenta_siesa != "" && password_siesa != "" && cuenta_papercut != "" && password_papercut != "" && estado1 != ""){
        ...
        if(tipo_asoc == <?php echo Yii::app()->params->ta_correo_skype_siesa_glpi_papercut ?>){
          //CORREO - SKYPE - SIESA - GLPI - PAPERCUT
          if(tipo_correo != "" && usuario_correo != "" && dominio_correo != "" && cuenta_correo != "" && password_correo != "" && cuenta_skype != "" && password_skype != "" && cuenta_siesa != "" && password_siesa != "" && cuenta_glpi != "" && password_glpi != "" && cuenta_papercut != "" && password_papercut != "" && estado1 != ""){
        ...
        if(tipo_asoc == <?php echo Yii::app()->params->ta_glpi ?>){
          //GLPI
          if(cuenta_glpi != "" && password_glpi != "" && estado2 != ""){
            ...
            if(estado2 == ""){
              $('#error_estado_2').html('Estado no puede ser nulo');
              $('#error_estado_2').show(); 
            }
        ...
        if(tipo_asoc == <?php echo Yii::app()->params->ta_siesa ?>){
          //SIESA
          if(cuenta_siesa != "" && password_siesa != "" && estado2 != ""){
        ...
        if(tipo_asoc == <?php echo Yii::app()->params->ta_siesa_glpi ?>){
          //SIESA - GLPI 
          if(cuenta_siesa != "" && password_siesa != "" && cuenta_glpi != "" && password_glpi != "" && estado2 != ""){
  ...
  $("#Cuenta_Estado").change(function() {
      ...
      if(valor != ""){
        ...
        if(valor == <?php echo Yii::app()->params->estado_red_env ?> || valor == <?php echo Yii::app()->params->estado_red_ret ?> || valor == <?php echo Yii::app()->params->estado_red_vac ?>){
          $('#correo_red').show();
        }else{
          $('#correo_red').hide();
        }
  ...
  $("#Cuenta_Estado2").change(function() {
      var valor = $('#Cuenta_Estado2').val(); 
  ...
  $('#Cuenta_Tipo_Asociacion').val(<?php echo $model->Tipo_Asociacion ?>).trigger('change');

  //se carga el Estado de acuerdo al tipo de asociación
  var tipo_asoc = $('#Cuenta_Tipo_Asociacion').val();

  if(tipo_asoc == <?php echo Yii::app()->params->ta_glpi ?> || tipo_asoc == <?php echo Yii::app()->params->ta_siesa ?>){
    $('#Cuenta_Estado').val('').trigger('change');
    $('#Cuenta_Estado2').val(<?php echo $model->Estado ?>).trigger('change');
     
  }else{
    $('#Cuenta_Estado').val(<?php echo $model->Estado ?>).trigger('change');
    $('#Cuenta_Estado2').val('').trigger('change'); 
  }
...
function limpiar_errores(){
  ...
  $('#error_estado_2').html('');
  $('#error_estado_2').hide();
  $('#error_cuenta_red').html('');
  $('#error_cuenta_red').hide(); 
}
