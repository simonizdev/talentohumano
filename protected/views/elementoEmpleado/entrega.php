...
<div class="btn-group" style="padding-bottom: 2%" id="buttons">
    <button type="button" class="btn btn-success"  onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=empleado/entrega' ?>';"><i class="fa fa-reply"></i> Volver</button>
    <button type="submit" class="btn btn-success" onclick="return valida_opciones(event);" id="btn_submit" style="display: none;"><i class="fa fa-floppy-o"></i> Entregar item(s) selecionado(s)</button>
</div>
