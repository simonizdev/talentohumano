...
<h3>Visualizando fórmula médica de empleado</h3>

<div class="table-responsive">
<?php $path =Yii::app()->baseUrl.'/index.php?r=formulaMed/ExportPdf&id='; ?>
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes'=>array(
        ...
        array(
            'name' => 'Formula_Medica',
            'value' => ($model->Formula_Medica == "") ? "No asignado" : $model->Formula_Medica,
        ),
        array(
        ...
        array(
            'label'=>'',
            'type'=>'raw',
            'value'=>CHtml::link(CHtml::encode('Descargar PDF'), $path .$model->Id_Formula)
        ),
	),
)); ?>
