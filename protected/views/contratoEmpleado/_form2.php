...
<div class="row">
    <div class="col-sm-4">
        <div class="form-group">
            <?php echo $form->error($model,'Fecha_Liquidacion', array('class' => 'pull-right badge bg-red')); ?>
            <?php echo $form->label($model,'Fecha_Liquidacion'); ?>
            <?php echo $form->textField($model,'Fecha_Liquidacion', array('class' => 'form-control', 'readonly' => true)); ?>
        </div>
    </div> 
</div>
