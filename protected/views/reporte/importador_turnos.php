...
$(function() {
  ...
  $("#download").click(function() {
    ...
    $("#mensaje").html('');
    window.location =  "<?php echo Yii::app()->getBaseUrl(true).'/images/plantillas/plantilla_turno.xlsx'; ?>";
  });
  ...
  $("#valida_form").click(function() {
      ...
      if(valid_file == 1){
        ...
        $.ajax({
            url: "<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=reporte/uploadturnos'; ?>",  
            type: 'POST',
            // Form data
