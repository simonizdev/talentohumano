...
<h3>Asignación de presupuesto x vendedor</h3>
...
<div class="btn-group" style="padding-bottom: 2%" id="buttons">
	<button type="button" class="btn btn-success" onclick="location.href = '<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=cPresupuesto/admin'; ?>';"><i class="fa fa-reply"></i> Volver </button>
