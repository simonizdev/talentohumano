	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
	          	<?php echo $form->label($model,'Id_Dominio_Medico'); ?>
			    <?php echo $form->numberField($model,'Id_Dominio_Medico', array('class' => 'form-control', 'autocomplete' => 'off', 'type' => 'number')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'DominioMedico[padre]',
						'id'=>'DominioMedico_padre',
	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'DominioMedico[usuario_creacion]',
						'id'=>'DominioMedico_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'DominioMedico[usuario_actualizacion]',
						'id'=>'DominioMedico_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	...
	<div class="row">
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'DominioMedico[orderby]',
						'id'=>'DominioMedico_orderby',
						'data'=>$array_orden,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
	    	...
	    	<div class="form-group">
	          	<?php 
					$this->widget('application.extensions.PageSize.PageSize', array(
				        'mGridId' => 'dominio-medico-grid', //Gridview id
...
<script type="text/javascript">
	...
	function resetfields(){
		$('#DominioMedico_Id_Dominio').val('');
		$('#DominioMedico_padre').val('').trigger('change');
		$('#DominioMedico_Dominio').val('');
		$('#DominioMedico_usuario_creacion').val('').trigger('change');
		$('#DominioMedico_Fecha_Creacion').val('');
		$('#DominioMedico_usuario_actualizacion').val('').trigger('change');
		$('#DominioMedico_Fecha_Actualizacion').val('');
		$('#DominioMedico_Estado').val('').trigger('change');
		$('#DominioMedico_orderby').val('').trigger('change');
		$('#yt0').click();
	}
