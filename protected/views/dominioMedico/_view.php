...
/* @var $data DominioMedico */
?>

<div class="view">

	<b><?php echo CHtml::encode($data->getAttributeLabel('Id_Dominio_Medico')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->Id_Dominio), array('view', 'id'=>$data->Id_Dominio_Medico)); ?>
	<br />
