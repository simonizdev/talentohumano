...
$(function() {
  ...
  var img = '<?php echo $model->Soporte; ?>';
  if(img != ""){
     img = '<?php echo Yii::app()->baseUrl."/images/soporte_estudios/".$model->Soporte; ?>';
    $('#img').attr('src', img);  
  }else{
    img = '<?php echo Yii::app()->baseUrl."/images/soporte_estudios/default.jpg"; ?>';
    $('#img').attr('src', img);   
  }
