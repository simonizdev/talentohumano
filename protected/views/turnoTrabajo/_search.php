	...
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php echo $form->numberField($model,'Id_Turno_Trabajo', array('class' => 'form-control', 'autocomplete' => 'off', 'type' => 'number')); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
	          	<?php echo $form->label($model,'Rango_Dias1'); ?>
			    <?php echo $form->textField($model,'Rango_Dias1', array('class' => 'form-control', 'autocomplete' => 'off', 'maxlength'=>3)); ?>
	        </div>
	    </div>
		<div class="col-sm-3">
	    	<div class="form-group">
	          	<?php echo $form->label($model,'Entrada1'); ?>
			    <?php echo $form->textField($model,'Entrada1', array('class' => 'form-control timepicker', 'autocomplete' => 'off', 'readonly' => true)); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
	          	<?php echo $form->label($model,'Salida1'); ?>
			    <?php echo $form->textField($model,'Salida1', array('class' => 'form-control timepicker', 'autocomplete' => 'off', 'readonly' => true)); ?>
	        </div>
	    </div>
	</div>
	<div class="row">
	    <div class="col-sm-3">
	    	<div class="form-group">
			    ...
			    <?php echo $form->textField($model,'Rango_Dias2', array('class' => 'form-control', 'autocomplete' => 'off', 'maxlength'=>3)); ?>
	        </div>
	    </div>
		<div class="col-sm-3">
	    	<div class="form-group">
	          	<?php echo $form->label($model,'Entrada2'); ?>
			    <?php echo $form->textField($model,'Entrada2', array('class' => 'form-control timepicker', 'autocomplete' => 'off', 'readonly' => true)); ?>
	        </div>
	    </div>
	    <div class="col-sm-3">
	    	<div class="form-group">
	          	<?php echo $form->label($model,'Salida2'); ?>
			    <?php echo $form->textField($model,'Salida2', array('class' => 'form-control timepicker', 'autocomplete' => 'off', 'readonly' => true)); ?>
	        </div>
	    </div>
	</div>
	<div class="row">
	    	...
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'TurnoTrabajo[usuario_creacion]',
						'id'=>'TurnoTrabajo_usuario_creacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
	    ...
	    <div class="col-sm-3">
	    	<div class="form-group">
            	...
            	<?php
            		$this->widget('ext.select2.ESelect2',array(
						'name'=>'TurnoTrabajo[usuario_actualizacion]',
						'id'=>'TurnoTrabajo_usuario_actualizacion',
						'data'=>$lista_usuarios,
						'htmlOptions'=>array(),
					  	'options'=>array(
    						'placeholder'=>'Seleccione...',
...
<script type="text/javascript">
	...
	function resetfields(){
		...
		$('#TurnoTrabajo_usuario_creacion').val('').trigger('change');
		$('#TurnoTrabajo_Fecha_Creacion').val('');
		$('#TurnoTrabajo_usuario_actualizacion').val('').trigger('change');
