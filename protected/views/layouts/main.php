          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo Yii::app()->user->getState('name_user'); ?>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=usuarios/password'; ?>" class="btn btn-default btn-flat">Cambiar credenciales</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo Yii::app()->getBaseUrl(true).'/index.php?r=site/logout'; ?>" class="btn btn-default btn-flat">Cerrar sesión</a>
                </div>
              </li>
            </ul>
          </li>
