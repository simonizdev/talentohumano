...
class CPtjVentas extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('ROWID, TIPO, PORCENTAJE, ESTADO, ID_USUARIO_CREACION, FECHA_CREACION, ID_USUARIO_ACTUALIZACION, FECHA_ACTUALIZACION, usuario_creacion, usuario_actualizacion', 'safe', 'on'=>'search'),
		);
	}
