...
/**
 * This is the model class for table "TH_SUBAREA_USUARIO".
 *
 * The followings are the available columns in table 'TH_SUBAREA_USUARIO':
...
class SubareaUsuario extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('Id_S_Usuario, Id_Usuario, Id_Usuario_Creacion, Id_Usuario_Actualizacion, Id_Subarea, Estado, Fecha_Creacion, Fecha_Actualizacion, usuario, usuario_creacion, usuario_actualizacion, subarea, orderby', 'safe', 'on'=>'search'),
		);
	}
